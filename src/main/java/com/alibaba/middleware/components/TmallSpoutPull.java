...
public class TmallSpoutPull implements IRichSpout {
	private static Logger LOG = LoggerFactory.getLogger(TmallSpoutPull.class);
	...
	public void open(Map conf, TopologyContext context,
		...
		consumer = new DefaultMQPullConsumer("Tmall");
		...
		try {
			...
			consumer.registerMessageQueueListener(RaceConfig.MqTmallTradeTopic, null);
