...
public class TmallSpout implements IRichSpout, MessageListenerConcurrently {
	/**  */
	private static final long serialVersionUID = 8476906628618859716L;
	private static final Logger LOG = Logger.getLogger(TmallSpout.class);
	...
	public void open(Map conf, TopologyContext context,
		...
		try {
			...
			consumer.subscribe(RaceConfig.MqTmallTradeTopic, null);
